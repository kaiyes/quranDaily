...
export default function Sura({ route }) {
	...
	async function fetchPage() {
		...
		if (currentPage.surah === nextPage.surah) {
			console.log('arrived')
			...
			const suraPart = await data.slice(0, 5)
			// parseInt(currentPage.ayah) - 1,
			// parseInt(nextPage.ayah) - 1
			// )
			console.log('suraPart: ', suraPart)
